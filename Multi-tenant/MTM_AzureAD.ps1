<#
  .SYNOPSIS
  This script is used to garner AAD information across all customers and output that information to a CSV file
  .NOTES
...
##Azuer AD settings CSV Path
if($AzureADSettings){
  $AzureADSettingsReport = echo ([Environment]::GetFolderPath("Desktop")+"\Microsoft_${customerDomain}_OrgReports\AADSettings.csv")
  $AzureADSettings | Export-CSV -Path $AzureADSettingsReport -NoTypeInformation -Append
  }
